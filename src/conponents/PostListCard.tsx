...
export default function PostListCard({
  ...
  return (
    <Link href={`/posts/${path}`}>
      <article className='duration-200/30 mb-2 flex h-full w-full flex-col overflow-hidden rounded-md duration-300 ease-in-out dark:shadow-none sm:mb-0  sm:flex-row sm:hover:shadow-xl sm:dark:border-2 sm:dark:border-neutral-800 sm:dark:hover:border-blue-200/90'>
        <Image
